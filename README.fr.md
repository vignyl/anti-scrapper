...
| `level` | `ProtectionLevel` | hérite | Override local du niveau |
...
| `watermark` | `string` | `undefined` | ID de watermark stéganographique pour tracer les fuites |
...
Voir [ROADMAP.md](./ROADMAP.md). Prévus : couche serveur (tokenisation), WASM decoder, proof-of-work, fingerprinting headless avancé.
